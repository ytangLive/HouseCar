...
-(id) rootViewController{
    if(_rootViewController == nil){
        ...
        if(url){
            ...
            [_rootViewController loadUrl:[NSURL URLWithString:url] basePath:@"/" animated:NO callBackDelegate:nil];
        }
    }
    return _rootViewController;
}

-(void)setStyleController:(VTStyleController*)styleController setDomStyleController:(VTDomStyleController*)domStyleController
{
    if (domStyleController) {
        VTStyleController* newStyleController = [domStyleController styleController];
        
        styleController = [styleController addObjectFromStyleController:newStyleController];
    }
    ...
    if (domStyleController) {
        [self.domStyleSheet setStyleController:domStyleController refresh:NO];
        [[NSNotificationCenter defaultCenter] postNotificationName:@"DomStyleChangedNotification" object:nil];
        [self.domStyleSheet styleControllerChangedRefreshAssoiate];
    }
}
