...
-(void) setConfig:(id)config{
    ...
    if(url){
        ...
        [viewController loadUrl:[NSURL URLWithString:url] basePath:@"/" animated:NO callBackDelegate:nil];
...
-(NSString *) loadUrl:(NSURL *)url basePath:(NSString *)basePath animated:(BOOL)animated callBackDelegate:(id)delegate{
    ...
    if(alias){
        ...
        if(self.centerViewController){
            basePath = [self.centerViewController loadUrl:url basePath:basePath animated:animated callBackDelegate:nil];
        }
    }
...
-(BOOL) openUrl:(NSURL *)url animated:(BOOL)animated{
    ...
    if([url.scheme isEqualToString:scheme]){
        ...
        if([path isEqualToString:@"center"]){
            ...
            [self.centerViewController loadUrl:url basePath:@"/" animated:animated callBackDelegate:nil];
        }
        else if([path isEqualToString:@"left"]){
            [self focusLeft:animated];
            [self.leftViewController loadUrl:url basePath:@"/" animated:animated callBackDelegate:nil];
        }
        else if([path isEqualToString:@"right"]){
            [self focusRight:animated];
            [self.rightViewController loadUrl:url basePath:@"/" animated:animated callBackDelegate:nil];
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    if(centerView && self.view.window){
