...
//        size = [title sizeWithFont:font constrainedToSize:innerSize lineBreakMode:_lineBreakMode];
        size = [title VTSizeWithFont:font constrainedToSize:innerSize lineBreakMode:_lineBreakMode];
    }
...
//    [title drawInRect:textRect withFont:font lineBreakMode:_lineBreakMode alignment:_titleAlignment];
    ...
    [title VTDrawInRect:textRect withFont:font lineBreakMode:_lineBreakMode alignment:_titleAlignment color:textColor];
...
//        CGSize size = [title sizeWithFont:font minFontSize:[cell titleMinFontSize] actualFontSize:&fontSize forWidth:innerSize.width lineBreakMode:[cell lineBreakMode]];
        ...
        CGSize size = [title VTSizeWithFont:font minFontSize:[cell titleMinFontSize] actualFontSize:&fontSize forWidth:innerSize.width lineBreakMode:[cell lineBreakMode]];
...
//                        actualFontSize:&fontSize forWidth:innerSize.width lineBreakMode:[cell lineBreakMode]];
            size = [title VTSizeWithFont:font minFontSize:[cell titleMinFontSize] actualFontSize:&fontSize forWidth:innerSize.width lineBreakMode:[cell lineBreakMode]];
        }
        else{
//            size = [title sizeWithFont:font constrainedToSize:innerSize lineBreakMode:[cell lineBreakMode]];
            size = [title VTSizeWithFont:font constrainedToSize:innerSize lineBreakMode:[cell lineBreakMode]];
        }
